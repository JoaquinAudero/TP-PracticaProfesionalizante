...
namespace Vista
{
    public partial class ModificarProveedor : Form
    {
        ...
        private void ModificarProovedorFront()
        {
            ...
            else
            {
                ...
                DialogResult result = MessageBox.Show("Esta seguro que quiere modificar al proveedor:  " + persona.apellido, "", MessageBoxButtons.YesNo);
                if (result == DialogResult.Yes)
                {
                    principal.ModificarProveedor(Convert.ToInt32(txtIdClienteNuevo.Text), persona, Convert.ToInt64(txtCuil.Text));
                    LimpiarCampos();
