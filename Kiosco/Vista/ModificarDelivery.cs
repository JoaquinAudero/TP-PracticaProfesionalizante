...
namespace Vista
{
    public partial class ModificarDelivery : Form
    {
        public ModificarDelivery()
        {
            InitializeComponent();
        }
        ...
        private void ModificarDelivery_Load(object sender, EventArgs e)
        {
        ...
        private void ModificarDeliveryFront()
        {
            ...
            else
            {
                ...
                {
                    principal.ModificarDelivery(Convert.ToInt32(txtIdClienteNuevo.Text), persona, Convert.ToInt64(txtDni.Text));
                    LimpiarCampos();
